...
어린이집 교사의 가장 큰 격무 중 하나인 **"키즈노트 알림장 작성"**과 **"평가제 보육/관찰일지 작성"**을 1회의 거친 메모 또는 활동 사진 입력만으로 완벽하게 해결합니다.

### 🌟 3대 핵심 원칙
1. **Zero Burden (입력 피로 0)**: 정돈되지 않은 거친 단편 메모나 음성 녹음(STT), 스마트폰 사진 1~2장만으로 즉시 완성본 도출.
